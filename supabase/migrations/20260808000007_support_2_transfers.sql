-- ============================================================
-- Buseo — Migración 07: rutas con 2 transbordos
-- ============================================================
-- El RPC search_all_routes (migración 06) solo buscaba rutas
-- directas y con 1 transbordo. Esta migración lo extiende para
-- cubrir también rutas con 2 transbordos, manteniendo la
-- penalización de +10 min POR CADA transbordo (+20 min total).
--
-- Con esto queda cubierta la red real del Metropolitano, donde
-- ningún viaje razonable requiere más de 2 transbordos.
-- ============================================================
...
--   Buscar un par que requiera 2 transbordos, p.ej.:
--   SELECT * FROM search_all_routes(
--     (SELECT id FROM stations WHERE name='naranjal'),
--     (SELECT id FROM stations WHERE name='matellini'));
--   Debe incluir rutas con "transfers": 2 y etaMin con +20 min.
-- ============================================================
